    ...
    <div class="left-content">
      <div class="box">
        <div class="cell"><a href="/#/index"
             class="a-link">首页</a><span> › </span><span>设置</span>
        </div>
        <div class="cell">
          <div class="form-item">
            <div class="form-label"></div>
            <div class="form-content"><strong>国科大在线网 第 {{data.id}} 号会员</strong></div>
          </div>
          <br>
          <div class="form-item">
          ...
          <div class="form-item">
            <div class="form-label"><strong>来自</strong></div>
            <div class="form-content"><Input v-model="data.location"
                     style="width: 200px;" /></div>
          </div>
          <div class="form-item">
            <div class="form-label"><strong>专业</strong></div>
